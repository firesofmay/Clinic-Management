...
Begin VB.Form PrintBill 
   ...
   Begin VB.ListBox lstTemptime 
      Height          =   450
      ItemData        =   "PrintBill.frx":540E7
      Left            =   840
      List            =   "PrintBill.frx":5410F
      TabIndex        =   7
      TabStop         =   0   'False
      Top             =   5280
      Visible         =   0   'False
   ...
   Begin VB.ListBox cmbT 
      ...
      EndProperty
      Height          =   3480
      ItemData        =   "PrintBill.frx":54197
      Left            =   8400
      List            =   "PrintBill.frx":54199
      TabIndex        =   2
      Top             =   1920
      Width           =   2175
   End
   Begin VB.ComboBox cmbDr 
      Height          =   315
      ItemData        =   "PrintBill.frx":5419B
      Left            =   360
      List            =   "PrintBill.frx":5419D
...
Private Sub cmbDr_Click()
    ...
    For i = 0 To lstTemptime.ListCount - 1
        tempstr = "select * from appt where presc_id is not null and doc_id = " & doc_id & " and appt_date = '" & appt_date & "' and appt_time = '" & lstTemptime.List(i) & "'"
